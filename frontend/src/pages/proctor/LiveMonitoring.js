...
const STATE = {
  in_progress: { l: "Sedang Mengerjakan", c: "#C9A227", bg: "#FBF3DC", pulse: true },
      ...
      <PageHeader title="Live Monitoring" subtitle="Pemantauan aktivitas belajar & ujian siswa sekolah Anda (diperbarui otomatis setiap 10 detik)."
        actions={
          <div className="flex items-center gap-3">
            ...
            <button onClick={load} className="p-2 rounded-full hover:bg-[#E6F5F8] text-[#0E7490]" data-testid="refresh-monitoring"><RefreshCw className="h-4 w-4" /></button>
          </div>
        } />
              ...
              return (
                <div key={r.student_id} className="bg-white rounded-xl border border-[#E2E8F0] p-5" data-testid={`monitor-${r.student_id}`}>
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      <div className="h-10 w-10 rounded-full bg-[#E6F5F8] text-[#0E7490] flex items-center justify-center text-sm font-bold">
                  ...
                  <div className="mt-4 rounded-lg bg-[#EFF6F8] p-3">
                    ...
                    <div className="mt-1 flex items-center justify-between">
                      ...
                      {r.last_score != null && <span className="font-mono2 text-sm font-bold" style={{ color: r.last_score >= 70 ? "#10B981" : "#C9A227" }}>{r.last_score}%</span>}
                    </div>
                  </div>
                </div>
              );

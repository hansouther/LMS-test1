    ...
    <div className="min-h-screen flex items-center justify-center p-6 bg-[#F4F7FE]">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl border border-[#E2E8F0] p-6 sm:p-8">
          ...
          <p className="mt-2 text-sm text-[#475569]">Daftarkan sekolah Anda untuk memantau siswa. Akun akan aktif setelah diverifikasi admin. Sudah punya akun? <Link to="/login" className="text-[#4361EE] font-semibold hover:underline">Masuk</Link></p>
